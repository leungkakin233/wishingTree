...
function draw(obj, context, width, height) {
	var pattern = context.createPattern(obj, "no-repeat");
	context.roundRect(250, 250, width, height, 12);
...
//								d.fillRect((b.width - b.imgWidth - 20) / 2, (b.height - b.imgHeight - 20) / 2,
//									(b.imgWidth + 20), (b.imgWidth + 20));
							fillRoundRect(d,(b.width - b.imgWidth - 35) / 2,(b.height - b.imgHeight - 35) / 2, b.imgWidth + 35, b.imgHeight + 35 , 20, d.fillStyle);
