...
(function($, window) {
	...
	Transparent.prototype.handleScroll = function(e) {
		...
		//梁家健 2019.5.5
		// 新增（因为无论当前event是默认Event还是mui的CustomEvent，其type值都是'scroll'，还有一种情况是TouchEvent，但此event没有type值，所以仅靠event.type是否是'scroll'就可以屏蔽掉TouchEvent的情况了
		...
		if(opacity > this._A) {
			...
			document.getElementById('headImg').src='images/pub_ico_goback.png';
			document.getElementById('menuImg').src='images/pub_ico_more.png';
			
		} else {
			this.element.classList.remove(CLASS_ACTIVE);
			document.getElementById('headerTitle').style.color = 'white';
			document.getElementById('menu').style.color = 'white';
			document.getElementById('menuImg').src='images/pub_ico_more_white.png';
			document.getElementById('headImg').src='images/pub_ico_goback_white.png';
		}
